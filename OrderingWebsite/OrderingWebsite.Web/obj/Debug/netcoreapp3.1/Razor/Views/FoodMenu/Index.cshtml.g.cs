#pragma checksum "/Users/k/Documents/ASP.NET_CORE/OrderingWebsite/OrderingWebsite.Web/Views/FoodMenu/Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0698de27c0069d5188fd056f062206c62e7ce678"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"0698de27c0069d5188fd056f062206c62e7ce678", @"/Views/FoodMenu/Index.cshtml")]
    public class Views_FoodMenu_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        <el-table :data=""tableData""
            ...
            <el-table-column fixed=""right""
                ...
                <template slot-scope=""scope"">
                    <el-button ");
            WriteLiteral("@click=\"editFoodMenu(scope.row)\" type=\"primary\" size=\"small\">\r\n                        编辑\r\n                    </el-button>\r\n                    <el-button ");
            WriteLiteral(@"@click=""deleteFoodMenu(scope.row)"" type=""danger"" size=""small"">
                        删除
                    </el-button>
                </template>
            </el-table-column>
...
<script type=""text/javascript"">var foodMenu = {
        ...
        methods: {
            getData() {
             ");
            WriteLiteral(@"   var params = `pageNo=${this.pagerOpt.page}&pageSize=${this.pagerOpt.pageSize}`
     ...
     ");
            ...
            editOrder() {
                ...
                var item = this.tableData.find(x");
            WriteLiteral(@" => x.id == ids[0]);
                item.isEdit = true;
